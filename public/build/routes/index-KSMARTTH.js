import "/build/_shared/chunk-H4AUGJXH.js";
import {
  useTheme
...
import "/build/_shared/chunk-GEACNVWS.js";
import {
  __toESM
...
var Header = () => {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("header", {
    className: "flew-row flex items-center justify-between p-4 text-xl font-semibold",
    children: [
  ...
  switch (blob) {
    case "blob_1":
      return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("svg", {
        className: "md-min:w-full blob md-max:max-w-[40rem]",
        id: "blob_1",
        version: "1.1",
...
var sprite_default = "/build/_assets/sprite-VJQODMRP.svg";

// app/components/Icons/Company/Company.tsx
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var Company = ({ name, website }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
  className: "company-icon md-max:company-icon--m sm-max:company-icon--s relative flex flex-col items-center justify-center rounded-lg\n",
...
var SocialIcons = ({ icons }) => {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
    ...
    children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
      className: "md-max:w-sm flex w-[170px] justify-between md-max:w-[140px]",
    ...
    children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Card, {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Title, {
          size: "h1" /* H1 */,
          className: "social-title mb-4 text-justify",
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Paragraph, {
          className: "mb-4 h-16 md-max:text-c5 dark:md-max:text-c4 sm-min:mb-0 md-min:mb-10 md-min:h-8",
...
var SocialSection = ({
  ...
  className: "relative flex max-h-[50rem] text-c4 dark:text-c5 md-max:max-h-full md-max:flex-col",
  children: [
...
//# sourceMappingURL=/build/routes/index-KSMARTTH.js.map
