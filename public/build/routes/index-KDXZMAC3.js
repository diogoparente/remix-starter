...
var Paragraph = ({
  ...
  className: `text-l md-max:text-m font-medium text-c4 text-shadow ${className != null ? className : ""}`,
  children
}, void 0, false, {
    ...
    children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Card, {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Paragraph, {
          className: "sm-max:h-6 md-max:mb-6 md-max:h-12 md-max:text-c5 dark:md-max:text-c4 lg-max:h-16",
...
//# sourceMappingURL=/build/routes/index-KDXZMAC3.js.map
